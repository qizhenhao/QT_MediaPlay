...
Item {
    ...
    property bool isPlaylistShuffle: false
    ...
    property url shuffleIcon: !root.listIsShuffled ? Config.iconSource("Shuffle_Icon"):Config.iconSource("Shuffle_Active",false)
